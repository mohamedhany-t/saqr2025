...
export default function DashboardRouterPage() {
  ...
  switch (role) {
    ...
    default:
      // You can render an "Unauthorized" page or redirect them
      return (
         <div className="flex min-h-screen w-full items-center justify-center bg-muted/30 flex-col gap-4">
            <h1 className="text-2xl font-bold">غير مصرح لك بالدخول</h1>
            <p>لا يوجد لديك دور معين في النظام. يرجى التواصل مع المسؤول.</p>
