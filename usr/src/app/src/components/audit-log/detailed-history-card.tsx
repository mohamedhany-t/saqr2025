...
import type { Shipment, ShipmentHistory, ShipmentHistoryEntry, Governorate, Company, User, ShipmentStatusConfig } from '@/lib/types';
import { Card, CardContent, CardHeader, CardTitle } from '../ui/card';
import { Avatar, AvatarFallback, AvatarImage } from '../ui/avatar';
import { formatToCairoTime } from '@/lib/utils';
import { ArrowRight, Building, FileText, MapPin, Pencil, Trash2, Truck, User as UserIcon } from 'lucide-react';
...
export function DetailedHistoryCard({ 
    ...
    const legacyChange: ShipmentHistoryEntry | null = historyEntry.status
